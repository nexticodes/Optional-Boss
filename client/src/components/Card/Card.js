...
import dsc from '../../assets/Discord-Logo-COLORED.png';
            ...
            <div onClick={cardFlip} style={classToggle}>
                ...
                <div className="card__face card__face--back">
                    ...
                    <div className='card-social'>
                        <a href={props.member.ig} rel="noopener noreferrer"><img src={ig} alt='ig link'/></a>
                        <a href={props.member.twitter} rel="noopener noreferrer"><img src={tw} alt='twitter link'/></a>
                        <a href={props.member.twitch} rel="noopener noreferrer"><img src={ttv} alt='twitch link'/></a>
                    </div>
                </div>
            </div>
        </div>
